...
fn get_intent_classifier(classifier: &str) -> TFClassifierWrapper<Probability> {
    ...
    let intent_config = assistant_config.get_intent_configuration(classifier).yolo();
